...
//$tas_one = 'rerickso aschaef1 adysinge idavis1 idiazper asimanju jjschulz kpomroy nborrokh tallembe' ;
//$tas_two = 'rerickso idavis1 tallembe';
...
if (strpos($classFolder, 'cs1080') !== false) {
    ...
    $assignments = array(
        ...
        array('folder' => "class-exercise-8" , 'restricted' =>0),
        array('folder' => "class-exercise-9" , 'restricted' =>0),
        array('folder' => "class-exercise-10" , 'restricted' =>0),
        ...
        array('folder' => "live-lab8" , 'restricted' =>0),
